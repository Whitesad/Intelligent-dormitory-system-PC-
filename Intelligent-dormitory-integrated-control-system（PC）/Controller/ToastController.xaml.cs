...
{
    public sealed partial class ToastController : UserControl
    {
        ...
        public ToastController(string content, TimeSpan showTime) : this()
        {
            this.m_TextBlockContent = content;
            this.m_ShowTime = showTime;
        }

        public ToastController(string content) : this(content, TimeSpan.FromSeconds(2))
        {
        }
